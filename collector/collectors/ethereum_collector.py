# ========================================
# ETHEREUM COLLECTOR: Commented out for future implementation
# ========================================
# This entire module has been temporarily disabled to focus on Bitcoin and Solana.
# To re-enable:
# 1. Uncomment all code in this file
# 2. Uncomment Ethereum references in main.py (lines 71, 143-146, 294-295, 323-325, 549-553)
# 3. Uncomment Ethereum tables in clickhouse-init/01-init-schema.sql (lines 9-45)
# 4. Set ETHEREUM_ENABLED=true in .env
# 5. Add valid ETHEREUM_RPC_URL in .env
# ========================================
